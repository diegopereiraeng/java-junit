...
public class DirectoryListing implements RequestProcessor {
    ...
    private void appendLink(String fileName, String uri, PrintWriter writer) {
      ...
      //  writer.append(String.format("<li style='list-style-type:circle; padding:4px; background:#529e77;'>\n<a href=\"%s/%s\">%s</a>\n</li>\n", uri, fileName, "CustomerX")); // yellow
          writer.append(String.format("<li style=\"list-style-type:circle; padding:4px; background:red;\">\n<a href=\"%s/%s\">%s</a>\n</li>\n", uri, fileName, fileName)); // yellow
          writer.append(String.format("<li style=\"list-style-type:circle; padding:4px; background:white;\">%s\n</li>\n", "Customer Demo Banco de la República"));
    }
}
